...
-------------------------------------------------- 
FEATURES The plugin currently exposes the following sensors: 
- Boiler flow temperature
- Domestic hot water (DHW) tank temperature
- Outdoor temperature Each value is exposed in HomeKit as a temperature sensor.
--------------------------------------------------
REQUIREMENTS - Homebridge >= 1.8 - Node.js >= 18 - ETA boiler with REST API enabled 
...
{ "platform": 
    ...
    "pollInterval": 60, 
    "paths": { "boilerFlowTemp": "/120/10101/0/0/12241", 
...
-------------------------------------------------- 
DEVELOPMENT Source code: https://github.com/kestral-homekit/homebridge-eta-rest 
